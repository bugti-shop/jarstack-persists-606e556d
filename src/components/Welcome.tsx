    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-between p-6 py-12">
      ...
      >
        <button
          ...
          className="w-full bg-black text-white dark:bg-white dark:text-black rounded-full py-4 text-lg font-semibold shadow-lg hover:opacity-90 transition-opacity"
        >
          Get Started
        </button>
      </motion.div>
